...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	{ (TA_HLNG|TA_ACT), (intptr_t)(0), (TASK)(if_loop_input_task), INT_PRIORITY(LOOP_INPUT_PRIORITY), ROUND_STK_T(LOOP_INPUT_STACK_SIZE), NULL, "if_loop_input_task" },
	...
	{ (TA_HLNG), (intptr_t)(0), (TASK)(if_loop_output_task), INT_PRIORITY(LOOP_OUTPUT_PRIORITY), ROUND_STK_T(LOOP_OUTPUT_STACK_SIZE), NULL, "if_loop_output_task" },
...
static DTQMB _kernel_dtqmb_DTQ_LOOP_OUTPUT[NUM_DTQ_LOOP_OUTPUT];
static DTQMB _kernel_dtqmb_DTQ_LOOP_INPUT[NUM_DTQ_LOOP_INPUT];
...
const DTQINIB _kernel_dtqinib_table[TNUM_SDTQID] = {
	{ (TA_TFIFO), (NUM_DTQ_LOOP_OUTPUT), _kernel_dtqmb_DTQ_LOOP_OUTPUT },
	{ (TA_TFIFO), (NUM_DTQ_LOOP_INPUT), _kernel_dtqmb_DTQ_LOOP_INPUT },
